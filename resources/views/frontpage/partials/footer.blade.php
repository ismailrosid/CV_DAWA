<footer style="background-color: #131f02d7;" class="footer spad text-white">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <ul class="mb-2">
                        <li class="text-white">Kunjungi kami di :</li>
                    </ul>
                    <ul>
                        ...
                        <li class="d-flex gap-3 align-items-center">
                            ...
                            <div>
                                <p class="lh-1 mb-0">hello@mediplants.co.id</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="footer__widget">
                    ...
                    <p class="text-white">Temukan Informasi Seputar Kesehatan Dan Herbal Anda!</p>
                    <form action="#">
