...
@section('title', 'ADM - Data Tips Herbal')
@push('styles')
    <!-- DataTables CSS -->
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Data Tips Herbal</h3>
                            ...
                            <table id="example1" class="table table-sm table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 21%"
                                            class="border-left-0 border-top-0 border-bottom-0 text-center">JUDUL</th>
                                        <th style="width: 31%"
                                            class="border-left-0 border-top-0 border-bottom-0 text-center"> TIPS</th>
                                        <th style="width: 31%"
                                            class="border-left-0 border-top-0 border-bottom-0 text-center">MANFAAT</th>
                                        <th style="width: 10%"
    ...
    <script>
        $(function() {
            var table = $("#example1").DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('admin.tips-herbal.data') }}", // Sesuaikan route untuk mengambil data
                    "type": "GET"
                },
                "columns": [{
                        "data": null,
                        ...
                        "render": function(data, type, row, meta) {
                            return type === 'display' ? meta.row + meta.settings._iDisplayStart +
                                1 : meta.row + 1;
                        },
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return `
                        <a href="{{ route('admin.tips-herbal.edit', '') }}/${row.id}" class="btn m-0 btn-warning btn-sm" title="Edit">
                ...
                "buttons": [{
                        ...
                        title: 'Data_tips_herbal_' + getCurrentDate(),
                        exportOptions: {
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config) {
                            window.location.href = "{{ route('admin.tips-herbal.create') }}";
                        }
                    }
                ],
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.tips-herbal.destroy', '') }}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
