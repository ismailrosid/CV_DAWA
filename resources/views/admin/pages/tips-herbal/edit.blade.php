                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Tips Herbal</h3>
                        ...
                        <form method="POST" action="{{ route('admin.tips-herbal.update', $tipsHerbal->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" class="form-control form-control-sm" id="id_kategori"
                                    name="id_kategori" value="{{ $tipsHerbal->id_kategori }}">

                                <!-- Input Judul -->
                                <div class="mb-2">
                                    <label for="judul" class="form-label">JUDUL:</label>
                                    <input type="text" class="form-control form-control-sm" id="judul" name="judul"
                                        value="{{ $tipsHerbal->judul }}" placeholder="Masukkan judul" pellcheck="false"
                                        autocomplete="off">
                                </div>
                                <hr>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control form-control-sm" id="tips" name="tips" rows="3"
                                        placeholder="Masukkan tips herbal" pellcheck="false" autocomplete="off">{{ $tipsHerbal->tips }}</textarea>
                                </div>
                                <hr>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control form-control-sm" id="manfaat" name="manfaat" rows="3"
                                        placeholder="Masukkan manfaat" pellcheck="false" autocomplete="off">{{ $tipsHerbal->manfaat }}</textarea>
                                </div>
                            </div>
