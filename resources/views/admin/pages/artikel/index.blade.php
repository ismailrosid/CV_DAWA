...
@section('title', 'ADM - Data Artikel')
@push('styles')
    <!-- DataTables CSS -->
                            ...
                            <table id="example1" class="table table-sm table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%"
                                            class="border-left-0 border-top-0 border-bottom-0 text-center">NAMA</th>
                                        <th style="width: 15%"
                                            class="border-left-0 border-top-0 border-bottom-0 text-center">JUDUL
                                        </th>
                                        <th class="border-left-0 border-top-0 border-bottom-0 text-center">DESKRIPSI</th>
                                        <th class="border-left-0 border-top-0 border-bottom-0 text-center">KESIMPULAN</th>
                                        <th style="width: 10%"
        ...
        $(function() {
            var table = $("#example1").DataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            return `
                        <a href="{{ route('admin.artikel.edit', '') }}/${row.id}" class="btn m-0 btn-warning btn-sm" title="Edit">
                ...
                "buttons": [{
                        ...
                        title: 'Data_artikel' + '(' + getCurrentDate() + ')',
                        exportOptions: {
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.artikel.destroy', '') }}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
