                        ...
                        <form method="POST" action="{{ route('admin.artikel.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" class="form-control form-control-sm" id="id_kategori"
                                    name="id_kategori" value="1">

                                <!-- Input Nama -->
                                <div class="mb-2">
                                    <label for="nama" class="form-label">NAMA:</label>
                                    <input type="text" class="form-control form-control-sm" id="nama" name="nama"
                                        placeholder="Masukkan nama" spellcheck="false" autocomplete="off">
                                </div>
                                <hr>
                                <!-- Input Judul -->
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control form-control-sm" id="deskripsi" name="deskripsi" rows="3"
                                        placeholder="Masukkan kombinasi herbal" spellcheck="false" autocomplete="off"></textarea>
                                </div>
                                <hr>
                                <!-- Input Detail -->
                                <div class="mb-2">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center vertical-align-middle">
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="nama_herbal[]" placeholder="Masukkan nama herbal"
                                                        spellcheck="false" autocomplete="off">
                                                </td>
                                                <td class="text-center vertical-align-middle">
                                                    <textarea class="form-control form-control-sm" name="manfaat[]" rows="3" placeholder="Masukkan manfaat"
                                                        spellcheck="false" autocomplete="off"></textarea>
                                                </td>
                                                <td
                                                    class="text-center
                                                        vertical-align-middle">
                                                    <textarea class="form-control form-control-sm" name="deskripsi_herbal[]" rows="3"
                                                        placeholder="Masukkan deskripsi herbal" spellcheck="false" autocomplete="off"></textarea>
                                                </td>
                                                <td class="text-center vertical-align-middle">
                                                    <textarea class="form-control form-control-sm" name="cara_kerja[]" rows="3" placeholder="Masukkan cara kerja"
                                                        spellcheck="false" autocomplete="off"></textarea>
                                                </td>
                                                <td class="text-center vertical-align-middle">
                                                    <textarea class="form-control form-control-sm" name="cara_konsumsi[]" rows="3"
                                                        placeholder="Masukkan cara konsumsi" spellcheck="false" autocomplete="off"></textarea>
                                                </td>
                                                <td class="text-center vertical-align-middle">
                                                    <button type="button"
                                                        class="btn text-danger btn-sm remove-input-dtl-artikel">
                                                        <i class="fas fa-minus"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control form-control-sm" id="kombinasi_herbal" name="kombinasi_herbal" rows="3"
                                        placeholder="Masukkan kombinasi herbal" spellcheck="false" autocomplete="off"></textarea>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea class="form-control form-control-sm" id="kesimpulan" name="kesimpulan" rows="3"
                                        placeholder="Masukkan kesimpulan" spellcheck="false" autocomplete="off"></textarea>
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                <tr style="display: none;">
                    ...
                    <td class="text-center vertical-align-middle">
                        <input type="text" class="form-control form-control-sm" name="nama_herbal[]" placeholder="Masukkan nama herbal" spellcheck="false" spellcheck="false" autocomplete="off">
                    </td>
                    <td class="text-center vertical-align-middle">
                        <textarea class="form-control form-control-sm" name="manfaat[]" rows="3" placeholder="Masukkan manfaat" spellcheck="false" autocomplete="off"></textarea>
                    </td>
                    <td class="text-center vertical-align-middle">
                        <textarea class="form-control form-control-sm" name="deskripsi_herbal[]" rows="3" placeholder="Masukkan deskripsi" spellcheck="false" autocomplete="off"></textarea>
                    </td>
                    <td class="text-center vertical-align-middle">
                        <textarea class="form-control form-control-sm" name="cara_kerja[]" rows="3" placeholder="Masukkan cara kerja" spellcheck="false" autocomplete="off"></textarea>
                    </td>
                    <td class="text-center vertical-align-middle">
                        <textarea class="form-control form-control-sm" name="cara_konsumsi[]" rows="3" placeholder="Masukkan cara konsumsi" spellcheck="false" autocomplete="off"></textarea>
                    </td>
                    <td class="text-center vertical-align-middle">
