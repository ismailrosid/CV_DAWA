...
<head>
    ...
    <style>
        ...
        .why-text p.price span.price-dc {
            text-decoration: line-through;
            color: #b3b3b3;
        }

        .why-text p.price span.price-sale {
            color: #82ae46;
        }
        ...
        .tooltip.bs-tooltip-right .arrow:before {
            border-right-color: #7fad39 !important;
            padding-top: 0px !important;
            top: 0px !important;
        }

        .tooltip.bs-tooltip-left .arrow:before {
            border-left-color: #7fad39 !important;
            padding-top: 0px !important;
        ...
        .accordion-button:not(.collapsed) {
            color: #000000;
            background-color: #7ead392f;
            box-shadow: inset 0 -1px 0 rgba(0, 0, 0, 0.125);
        }

        .accordion-button:not(.collapsed)::after {
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%237fad39'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
